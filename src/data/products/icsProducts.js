...
const ICSProducts = [
  ...
  new Product('695XL PG Gas Power Cutter', Brands.ics, Categories.powerCut, new Attributes(PowerTypes.gas)),
  new Product('695XL Gas Power Cutter', Brands.ics, Categories.powerCut, new Attributes(PowerTypes.gas)),
  new Product('680ES PG Gas Power Cutter', Brands.ics, Categories.powerCut, new Attributes(PowerTypes.gas)),
  new Product('680ES Gas Power Cutter', Brands.ics, Categories.powerCut, new Attributes(PowerTypes.gas)),
  new Product('890PG Hydraulic Power Cutter', Brands.ics, Categories.powerCut, new Attributes(PowerTypes.hydraulic)),
  new Product('890F4 Flush Cut Hydraulic Power Cutter', Brands.ics, Categories.powerCut, new Attributes(PowerTypes.hydraulic)),
  new Product('890F4 Flush Cut Hydraulic Power Cutter', Brands.ics, Categories.powerCut, new Attributes(PowerTypes.hydraulic)),
